...
OrGate::OrGate(GLfloat x, GLfloat y, GLfloat angle) : BinaryGate(x, y, angle)
{
}
...
void OrGate::Draw(GLenum mode)
{
	...
	{
		// Draw the schematic symbole for an OR gate.
		glBegin(GL_LINES);
		glVertex2f(-1.f, 1.f);
		glVertex2f(1.f, 1.f);
		glVertex2f(-1.f, -1.f);
